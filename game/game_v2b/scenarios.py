...
#Q:/65_PGM/65_PYT/game.game_v2b/scenarios.py
"""
...
Nebudete-li si vědět rady, zadejte znak ?.""",
          PN.house,
          (PN.wood,),
          (IN.cake, IN.vine, IN.table, IN.doll, ),
          (),
    )
...
_HAPPY = Scenario('HAPPY',
    ...
    steps = (
        _START_STEP
        ,
        _Step(f'{AN.take} {IN.vine.lower()}',
              f'{AM.take_done} {IN.vine}',
              PN.house,
              (PN.wood, ),
        ...
        _Step(f'{AN.put} {IN.vine.upper()}',
              f'{AM.put_done} {IN.vine}',
              PN.cottage,
              (PN.forest, ),
              (IN.bed, IN.table, IN.granny, IN.cake, IN.vine, ),
              (),
              ),
        _Step(AN.end,
              AM.end_done,
